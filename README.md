...
## Environments
- Preview: https://main--fuzzy-octo-spork--oscarsalasomnipro.aem.page/
- Live: https://main--fuzzy-octo-spork--oscarsalasomnipro.aem.live/
...
1. Open the `fuzzy-octo-spork` directory in your favourite IDE and start coding :)
